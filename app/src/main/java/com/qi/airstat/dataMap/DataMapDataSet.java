...
public class DataMapDataSet {
    private static DataMapDataSet instance;
...
//    public static DataMapDataSet create(double temparature, double co, double so2, double no2, double o3, double pm){
//        return
//    }
    ...
    public double getAqiValue() {
        int count = 0;
        double coResult, so2Result, no2Result, o3Result, pmResult, total;
        ...
        total = (coResult + so2Result + no2Result + o3Result + pmResult) / count;
    ...
    private double getO3Grade(double o3) {
        if (0 <= o3 && o3 <= 54) {
            ...
            return (100 - 51) * (o3 - 55) / (70 - 55) + 51;
        } else if (70 < o3 && o3 <= 85) {
            return (150 - 101) * (o3 - 71) / (85 - 71)+101;
        } else if (85 < o3 && o3 <= 105) {
            return (200 - 151) * (o3 - 86) / (105 - 86)+151;
        } else if (105 < o3 && o3 <= 200) {
            return (300 - 201) * (o3 - 106) / (200 - 106)+201;
        } else if (200 < o3 && o3 <= 504) {
            return (400 - 301) * (o3 - 405) / (504 - 405)+301;
        } else if (504 < o3 && o3 <= 605) {
            return (500 - 401) * (o3 - 505) / (605 - 505)+401;
        } else {
            return -1;
        }
    }
    ...
    private double getPmGrade(double pm) {
        if (0 <= pm && pm <= 12) {
            ...
            return (100 - 51) * (pm - 12.1) / (35.4 - 12.1)+51;
        } else if (35.5 < pm && pm <= 55.4) {
            return (150 - 101) * (pm - 35.5) / (55.4 - 35.5)+101;
        } else if (55.4 < pm && pm <= 150.4) {
            return (200 - 151) * (pm - 55.5) / (150.4 - 55.5)+151;
        } else if (150.4 < pm && pm <= 250.4) {
            return (300 - 201) * (pm - 150.5) / (250.4 - 150.5)+201;
        } else if (250.4 < pm && pm <= 350.4) {
            return (400 - 301) * (pm - 250.5) / (350.4 - 250.5)+301;
        } else if (350.4 < pm && pm <= 500.4) {
            return (500 - 401) * (pm - 350.5) / (500.4 - 350.5)+401;
        } else {
            return -1;
        }
    }
    ...
    private double getCoGrade(double co) {
        if (0 <= co && co <= 4.4) {
            ...
            return (100 - 51) * (co - 4.5) / (9.4 - 4.5)+51;
        } else if (9.4 < co && co <= 12.4) {
            return (150 - 101) * (co - 9.5) / (12.4 - 9.5)+101;
        } else if (12.4 < co && co <= 15.4) {
            return (200 - 151) * (co - 12.5) / (15.4 - 12.5)+151;
        } else if (15.4 < co && co <= 30.4) {
            return (300 - 201) * (co - 15.5) / (30.4 - 15.5)+201;
        } else if (30.4 < co && co <= 40.4) {
            return (400 - 301) * (co - 30.5) / (40.4 - 30.5)+301;
        } else if (40.4 < co && co <= 50.4) {
            return (500 - 401) * (co - 40.5) / (50.4 - 40.5)+401;
        } else {
            return -1;
        }
    }
    ...
    private double getSo2Grade(double so2) {
        if (0 <= so2 && so2 <= 35) {
            ...
            return (100 - 51) * (so2 - 36) / (75 - 36)+51;
        } else if (75 < so2 && so2 <= 185) {
            return (150 - 101) * (so2 - 76) / (185 - 76)+101;
        } else if (185 < so2 && so2 <= 304) {
            return (200 - 151) * (so2 - 186) / (304 - 186)+151;
        } else if (304 < so2 && so2 <= 604) {
            return (300 - 201) * (so2 - 305) / (604 - 305)+201;
        } else if (604 < so2 && so2 <= 804) {
            return (400 - 301) * (so2 - 605) / (804 - 605)+301;
        } else if (804 < so2 && so2 <= 1004) {
            return (500 - 401) * (so2 - 805) / (1004 - 805)+401;
        } else {
            return -1;
        }
    }
    ...
    private double getNo2Grade(double no2) {
        if (0 <= no2 && no2 <= 53) {
            ...
            return (100 - 51) * (no2 - 54) / (100 - 54)+51;
        } else if (100 < no2 && no2 <= 360) {
            return (150 - 101) * (no2 - 101) / (360 - 101)+101;
        } else if (360 < no2 && no2 <= 649) {
            return (200 - 151) * (no2 - 361) / (649 - 361)+151;
        } else if (649 < no2 && no2 <= 1249) {
            return (300 - 201) * (no2 - 650) / (1249 - 650)+201;
        } else if (1249 < no2 && no2 <= 1649) {
            return (400 - 301) * (no2 - 605) / (1649 - 605)+301;
        } else if (1649 < no2 && no2 <= 2049) {
            return (500 - 401) * (no2 - 1650) / (2049 - 1650)+401;
        } else {
            return -1;
        }
    }
